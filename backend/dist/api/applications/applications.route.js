...
// Applicant routes
router.post("/", upload_middleware_1.injectApplicantInfo, upload_middleware_1.uploadApplicationDocuments, upload_middleware_1.handleUploadError, applications_controller_1.createApplication);
...
router.get("/:id/documents", applications_controller_1.getApplicationDocuments); // Get list of documents
router.get("/:id/documents/:documentIndex/download", applications_controller_1.downloadDocument); // Download specific document
...
router.put("/:id/interview", applications_controller_1.scheduleInterview);
router.put("/:id/interview-rating", applications_controller_1.rateInterview);
